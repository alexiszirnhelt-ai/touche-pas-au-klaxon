...
<div class="container mt-5" style="max-width: 540px;">
    ...
    <form action="/touche-pas-au-klaxon/public/trajet/edit/<?= (int) $trajet['id'] ?>" method="POST">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" id="datetime_depart" name="datetime_depart"
                   ...
                   value="<?= date('Y-m-d\TH:i', strtotime($trajet['datetime_depart'])) ?>">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="datetime-local" id="datetime_arrivee" name="datetime_arrivee"
                   class="form-control" required
                   value="<?= date('Y-m-d\TH:i', strtotime($trajet['datetime_arrivee'])) ?>">
        </div>

        <div class="mb-3">
            <label for="places_total" class="form-label">Nombre de places total</label>
        ...
        <div class="mb-4">
            ...
            <input type="number" id="places_dispo" name="places_dispo"
                   class="form-control" min="0" max="9" required
                   value="<?= (int) $trajet['places_dispo'] ?>">
        </div>
